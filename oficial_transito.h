...
start:
    while (info->oficial->sentido == 0 | info->oficial->contador_este < info->oficial->k_este)
        ;
...
start:
    while (info->oficial->sentido == 1 | info->oficial->contador_oeste < info->oficial->k_oeste)
    {
    }
